...
def save_plot(examples, epoch, n=1):
	...
	# save plot to file
	filename = cwd + '\\Neural_project\\src\\api\\static\\reportsgenerated_plot_e%03d.jpg' % (epoch+1)
...
def summarize_performance(epoch, g_model, d_model, dataset, latent_dim, n_samples=150):
	...
	filename = cwd + '\\Neural_project\\models\\generator_model_%03d.h5' % (epoch+1)
...
def train_run(augmentator_func, cargar_imagenes_func):
	...
	augmentator_func(num_samples=2000)
